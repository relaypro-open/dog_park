    ...
    render() {
      ...
      return(
          <div>
            ...
            <Button variant="fab" color="secondary" aria-label="Add" className={classes.speedDialButton} onClick={this.handleCreateZoneButton}>
              <AddIcon />
            </Button>
            ...
            >
              ...
              <DialogActions>
                ...
                <Button onClick={this.createZone} variant="contained" color="primary">
                  Create Zone
                </Button>

    ...
    render() {
      ...
      return(
          <div>
            ...
            <Button variant="fab" color="secondary" aria-label="Add" className={classes.speedDialButton} onClick={this.handleCreateGroupOpen}>
              <AddIcon />
            </Button>
            ...
            >
              ...
              <DialogContent>
                <DialogContentText>
                  Please enter the name of the group and the profile that you would like associated with it.
                </DialogContentText>
                <form>
                <TextField
                  autoFocus
              ...
              <DialogActions>
                ...
                <Button onClick={this.createGroup} variant="contained" color="primary">
                  Create Group
                </Button>

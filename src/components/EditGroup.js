...
class EditGroup extends Component {
  ...
  updateGroup() {
    ...
    this.setState({editGroupStatus: <div><CircularProgress/></div>});
    api.put('/group/' + this.props.groupId, {
  ...
  render () {
    ...
    return (
      ...
      >
        <DialogTitle id="form-dialog-title">Edit {this.props.groupName}</DialogTitle>
        <DialogContent>
          <DialogContentText>

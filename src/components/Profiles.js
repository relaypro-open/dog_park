  ...
  constructor(props) {
    ...
    createProfile = () => {
        ...
        api.post('profile', {
          ...
          "rules": {'inbound': [{'order': 1, 'active': false, 'interface': '', 'group': ' ', 'group_type': 'ANY', 'service': ' ', 'action': 'ACCEPT', 'log': false, 'log_prefix': '', 'comment': '', 'type': 'BASIC'}],
          'outbound': [{'order': 1, 'active': false, 'interface': '', 'group': ' ', 'group_type': 'ANY', 'service': ' ', 'action': 'ACCEPT', 'log': false, 'log_prefix': '', 'comment': '', 'type': 'BASIC'}]},
        }).then((response) => {
          ...
          <div>
            ...
            >
              ...
              <DialogActions>
                ...
                <Button onClick={this.createProfile} variant="contained" color="primary">
                  Create Profile
                </Button>
                &nbsp;&nbsp;{this.state.createProfileStatus}
              </DialogActions>
            </Dialog>
            <Button variant="fab" color="secondary" aria-label="Add" className={classes.speedDialButton} onClick={this.handleCreateProfileOpen}>
              <AddIcon />
            </Button>
          </div>
      );
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(Profiles));
